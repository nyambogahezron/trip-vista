...
export default function Agencies() {
  ...
  const filteredAgencies = agencies.filter(agency => {
    return (
      ...
      agency.locations.some(location =>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Trusted Tour Agencies
            </h1>
            <p className="text-lg text-muted-foreground mb-8">
              Connect with expert agencies who will create your perfect travel
              experience with local knowledge and personalized service.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="flex flex-col md:flex-row-reverse">
              ...
              <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                ...
                <p className="text-muted-foreground mb-6">
                  Partner with ExploreX and connect with thousands of travelers
                  looking for their next adventure. Showcase your unique tours
