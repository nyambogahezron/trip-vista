        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Have questions about planning your next adventure? Our team is
              here to help.
            </p>
          </motion.div>
        </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mt-1">
                        General Inquiries:{' '}
                        <a
                          href="mailto:hello@explorex.travel"
                          className="text-primary hover:underline"
                        >
                          hello@explorex.travel
                        </a>
                        <br />
                        Support:{' '}
                        <a
                          href="mailto:support@explorex.travel"
                          className="text-primary hover:underline"
                        >
                          support@explorex.travel
                        </a>
                        <br />
                        Partnerships:{' '}
                        <a
                          href="mailto:partners@explorex.travel"
                          className="text-primary hover:underline"
                        >
                          partners@explorex.travel
                        </a>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mt-1">
                        ...
                        <br />
                        Hours: 24/7 for emergencies, 9AM-6PM ET for general
                        inquiries
                      </p>
                    </div>
                  </div>
            ...
            {[
              {
                ...
                answer:
                  'You can book a tour directly through our website by browsing our destinations, selecting your preferred tour, and following the booking process. Alternatively, you can contact our customer service team for assistance.',
              },
              {
              ...
              },
              {
                ...
                answer:
                  "Most of our tour packages do not include international flights to give our customers flexibility in their travel arrangements. However, some packages may include domestic flights within the destination. The details of what's included are always clearly listed on the tour page.",
              },
              {
                question: 'Do you offer group discounts?',
                answer:
                  'Yes, we offer group discounts for parties of 8 or more travelers booking the same tour. Contact our group travel specialists for more information and custom quotes.',
              },
            ].map((faq, index) => (
              <motion.div
                key={index}
