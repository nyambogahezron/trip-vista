            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              >
                ...
                <p className="text-muted-foreground">
                  With over {new Date().getFullYear() - agency.foundedYear}{' '}
                  years of experience in the travel industry, {agency.name} has
                  been curating exceptional travel experiences across{' '}
                  {agency.locations.length} destinations worldwide. Our team of
                  expert travel consultants works tirelessly to create
                  personalized itineraries that match your preferences, budget,
                  and travel style.
                </p>
              </motion.div>
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-black/0 flex flex-col justify-end p-4">
                        <h3 className="text-white font-medium">
                          {agency.locations[index % agency.locations.length]}{' '}
                          Adventure
                        </h3>
              ...
              >
                ...
                <div className="mt-4 text-center">
                  <Button variant="outline" className="rounded-full">
                    See All {agency.reviewCount} Reviews
                  </Button>
                </div>
              </motion.div>
            </div>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a
                        href={`mailto:info@${agency.website}`}
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        {agency.locations[0]}, with offices in{' '}
                        {agency.locations.slice(1, 3).join(', ')}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                <p className="text-muted-foreground mb-6 relative">
                  Contact us today and let our experts help you create your
                  perfect journey.
                </p>
