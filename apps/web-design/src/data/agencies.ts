...
export const agencies: Agency[] = [
  {
    ...
    description:
      'Specializing in off-the-beaten-path adventures, our guides take you to untouched landscapes and authentic cultural experiences.',
    rating: 4.8,
    reviewCount: 235,
    specialties: [
      'Mountain Trekking',
  ...
  },
  {
    ...
    description:
      'Providing premium travel experiences with 5-star accommodations, private guides, and exclusive access to world-class attractions.',
    rating: 4.9,
    reviewCount: 187,
  ...
  },
  {
    ...
    description:
      "Sustainable travel that minimizes environmental impact while maximizing authentic experiences in nature's most pristine settings.",
    rating: 4.7,
    reviewCount: 156,
  ...
  },
  {
    ...
    description:
      "Urban adventures with insider access to the world's most vibrant cities, featuring local guides and authentic experiences.",
    rating: 4.6,
    reviewCount: 210,
