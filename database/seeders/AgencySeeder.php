    ...
    public function run(): void
    {
        ...
        $featuredAgencies = [
            [
                ...
                'description' => 'Specializing in thrilling outdoor adventures and extreme sports travel experiences around the world. We offer unmatched expertise in mountain climbing, white-water rafting, and wilderness expeditions.',
                ...
                'founded_year' => 2010,
                'specialties' => ['Adventure Travel', 'Extreme Sports', 'Mountain Expeditions', 'Wilderness Tours'],
                'locations' => ['California', 'Colorado', 'Utah', 'Montana', 'Alaska', 'Nepal'],
                'review_count' => 1247,
                'is_featured' => true,
            ...
            [
                ...
                'description' => 'Your gateway to the most beautiful tropical destinations, beaches, and island getaways worldwide. We specialize in luxury beach resorts and authentic island experiences.',
                'email' => 'bookings@tropicalparadise.com',
                'phone' => '+1-555-0202',
                'address' => '456 Beach Blvd, Miami, FL 33139',
                'website' => 'tropicalparadise.com',
                'social_media' => [
                ...
                'founded_year' => 2008,
                'specialties' => ['Beach Destinations', 'Luxury Travel', 'Honeymoon Packages', 'Island Hopping'],
                'locations' => ['Caribbean', 'Hawaii', 'Maldives', 'Fiji', 'Seychelles', 'Bali'],
                'review_count' => 892,
                'is_featured' => true,
            ...
            [
                ...
                'description' => 'Immerse yourself in rich cultures and historical sites with our expertly guided cultural tours. Experience authentic local traditions and UNESCO World Heritage sites.',
                'email' => 'explore@culturalheritage.com',
                'phone' => '+1-555-0303',
                'address' => '789 History Lane, Boston, MA 02108',
                'website' => 'culturalheritage.com',
                'social_media' => [
                ...
                'founded_year' => 2012,
                'specialties' => ['Cultural Tours', 'Heritage Sites', 'Educational Tours', 'Archaeological Tours'],
                'locations' => ['Europe', 'Asia', 'Egypt', 'Peru', 'Greece', 'Turkey'],
                'review_count' => 634,
                'is_featured' => true,
            ...
            [
                ...
                'description' => 'Discover the best of city life with our comprehensive urban exploration and metropolitan tours. From street art to rooftop dining, we show you the real city.',
                'email' => 'hello@urbanexplorer.com',
                'phone' => '+1-555-0404',
                'address' => '321 City Center, New York, NY 10001',
                'website' => 'urbanexplorer.com',
                'social_media' => [
                ...
                'founded_year' => 2015,
                'specialties' => ['City Tours', 'Food & Wine Tours', 'Street Art Tours', 'Architecture Tours'],
                'locations' => ['New York', 'London', 'Tokyo', 'Barcelona', 'Paris', 'Berlin'],
                'review_count' => 789,
                'is_featured' => false,
            ...
            [
                ...
                'description' => 'Experience the wild side of nature with our authentic safari experiences and wildlife encounters. Conservation-focused tours that support local communities.',
                'email' => 'safari@wildlifeadventures.com',
                'phone' => '+1-555-0505',
                'address' => '654 Safari Street, Denver, CO 80202',
                'website' => 'wildlifeadventures.com',
                'social_media' => [
                ...
                'founded_year' => 2009,
                'specialties' => ['Wildlife Safari', 'Eco Tourism', 'Photography Tours', 'Conservation Tours'],
                'locations' => ['Kenya', 'Tanzania', 'South Africa', 'Botswana', 'Costa Rica', 'Amazon'],
                'review_count' => 1156,
                'is_featured' => true,
                'featured_image' => 'https://images.unsplash.com/photo-1547036967-23d11aacaee0?w=800&h=600&fit=crop',
            ],
            [
                'name' => 'Family Adventure Co.',
                'logo' => 'https://images.unsplash.com/photo-1539635278303-d4002c07eae3?w=400&h=400&fit=crop&crop=face',
                'description' => 'Creating magical family memories with kid-friendly destinations and activities for all ages. Safety and fun are our top priorities.',
                'email' => 'families@familyadventure.com',
                'phone' => '+1-555-0606',
                'address' => '987 Family Way, Orlando, FL 32801',
                'website' => 'familyadventure.com',
                'social_media' => [
                    'facebook' => 'https://facebook.com/familyadventure',
                    'twitter' => 'https://twitter.com/familyadventure',
                    'instagram' => 'https://instagram.com/familyadventure',
                ],
                'rating' => 4.6,
                'location' => 'Orlando, Florida',
                'founded_year' => 2011,
                'specialties' => ['Family Travel', 'Theme Parks', 'Educational Tours', 'Kid-Friendly Adventures'],
                'locations' => ['Florida', 'California', 'Arizona', 'Hawaii', 'Mexico', 'Canada'],
                'review_count' => 567,
                'is_featured' => false,
                'featured_image' => 'https://images.unsplash.com/photo-1551632811-561732d1e306?w=800&h=600&fit=crop',
            ],
