...
export default function Index() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 z-20 text-center">
          ...
          >
            ...
            <Link to="/agencies">
              <Button variant="outline" size="lg" className="bg-white/20 backdrop-blur-xs border-white hover:bg-white/30 text-white px-8 py-6 text-lg rounded-full shadow-lg transition-transform hover:scale-105">
                Find Tour Agencies
              </Button>
            </Link>
          </motion.div>
        ...
        <div className="absolute bottom-8 left-0 right-0 z-20 flex justify-center animate-bounce">
          <a
            ...
            className="flex items-center justify-center w-10 h-10 rounded-full bg-white/20 backdrop-blur-xs text-white hover:bg-white/40 transition-colors"
      ...
      <section id="featured-destinations" className="py-20 bg-linear-to-b from-background to-muted">
