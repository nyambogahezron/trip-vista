...
import { Agency, Destination } from '@/types';
...
export default function Home({ featuredDestinations, featuredAgencies }: HomeProps) {
    ...
    const randomIndex = Math.floor(Math.random() * videosLinks.length);
    const selectedVideo = videosLinks[randomIndex];
    ...
    return (
        <AppLayout title="Home - Trip Vista">
            {/* Hero Section */}
                    ...
                    >
                        ...
                        <Link href="/agencies">
                            <Button
                                variant="outline"
                                size="lg"
                                className="rounded-full border-white bg-white/20 px-8 py-6 text-lg text-white shadow-lg backdrop-blur-sm transition-transform hover:scale-105 hover:bg-white/30"
                            >
                                Find Tour Agencies
                            </Button>
                        </Link>
            ...
            <section id="featured-destinations" className="bg-gradient-to-b from-background to-muted py-20">
                <div className="container mx-auto px-4">
                    ...
                    >
                        {featuredDestinations.slice(0, 4).map((destination: Destination) => (
                            <motion.div
                                key={destination.id}
            ...
            <section className="bg-muted py-20">
                <div className="container mx-auto px-4">
                    ...
                    <motion.div
                        ...
                        variants={staggerContainer}
                    >
                        {featuredAgencies.slice(0, 2).map((agency: Agency) => (
                            <motion.div
                                key={agency.id}
                            ...
                            >
                                ...
                                <div className="flex flex-col p-6 md:w-3/5">
                                    ...
                                    <div className="mt-auto mb-4 flex flex-wrap gap-2">
                                        {agency.specialties.slice(0, 3).map((specialty: string, index: number) => (
                                    ...
                                    <Link href={`/agencies/${agency.id}`} className="mt-auto self-start">
                ...
                <div className="relative z-20 container mx-auto px-4">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <motion.p
                            ...
                            viewport={{ once: true }}
                        >
                            Join thousands of travelers who have experienced the world with Trip Vista. Your journey begins here.
                        </motion.p>
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
